  ...
  return (
    <div className="min-h-screen bg-black pt-40 pb-20 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          <span className="text-[10px] uppercase tracking-[0.4em] text-white/40 font-black block mb-4">Segurança & Transparência</span>
            ...
            },
            {
              ...
              action: (
                <button 
                  ...
                  className="mt-4 px-6 py-2 rounded-xl bg-white/10 text-white hover:bg-white/20 transition-colors text-sm font-bold uppercase tracking-wider"
                >
                  Gerenciar Cookies
                </button>
              )
