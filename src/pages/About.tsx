        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center mb-24 lg:mb-32">
          ...
          >
            <div className="inline-block px-4 py-1 bg-white/5 backdrop-blur-md rounded-full mb-6 lg:mb-8 border border-white/10">
              <span className="text-[9px] sm:text-[10px] uppercase tracking-[0.4em] text-white/40 font-bold">{siteConfig.pages.about.hero.badge}</span>
            </div>
          ...
          >
            ...
            <div className="relative rounded-[2.5rem] sm:rounded-[3.5rem] overflow-hidden border border-white/10 shadow-2xl aspect-square sm:aspect-auto">
              ...
              <div className="absolute bottom-8 left-8 sm:bottom-10 sm:left-10">
                <p className="text-[9px] sm:text-[10px] uppercase tracking-[0.4em] text-white/60 font-black mb-2">{siteConfig.pages.about.hero.imageBadge.title}</p>
                <p className="text-xl sm:text-2xl font-display font-black text-white uppercase tracking-tight">{siteConfig.pages.about.hero.imageBadge.subtitle}</p>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          {siteConfig.pages.about.stats.items.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-display font-black text-xl sm:text-2xl text-white group-hover:text-black uppercase mb-3 tracking-tight">{item.value}</h3>
